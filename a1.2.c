...
// quick sort using as many threads as possible
void quick_sort_multiple_threads(struct block *my_data){
    ...
    int state=pthread_create(&new_thread, NULL, (void *)&quick_sort_multiple_threads, (void *)&right_side);
...
int main(int argc, char *argv[]) {
    ...
    quick_sort_multiple_threads(&start_block);
